                    ...
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            ...
                            <div class="width:60%">
                                ...
                                <ul>
                                    <li>collection_id: <?php  $_GET['collection_id']?></li>
                                    <li>collection_status: <?php  $_GET['collection_status']?></li>
                                    <li>external_reference: <?php  $_GET['external_reference']?></li>
                                    <li>merchant_account_id: <?php  $_GET['merchant_account_id']?></li>
                                    <li>merchant_order_id: <?php  $_GET['merchant_order_id']?></li>
                                    <li>payment_id: <?php  $_GET['payment_id']?></li>
                                    <li>payment_type: <?php  $_GET['payment_type']?></li>
                                    <li>preference_id: <?php  $_GET['preference_id']?></li>
                                    <li>processing_mode: <?php  $_GET['processing_mode']?></li>
                                    <li>site_id: <?php  $_GET['site_id']?></li>
                                    <li>status: <?php  $_GET['status']?></li>
                                </ul>
